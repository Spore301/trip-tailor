export class EstimationService {
    calculateTotalCost(activities, peopleCount, days) {
        const breakdown = {
            flights: 0,
            hotels: 0,
            attractions: 0,
    ...
    filterByBudget(activities, budget, peopleCount, days) {
        ...
        for (const activity of sorted) {
            const activityCost = activity.type === 'attraction' || activity.type === 'food' || activity.type === 'activity'
