...
class CarRentalService {
    ...
    normalizeBookingComResponse(data, params, coordinates) {
        if (!data.data || !Array.isArray(data.data)) {
            return [];
        }
        return data.data.slice(0, 10).map((rental) => {
...
//# sourceMappingURL=car-rental.service.js.map